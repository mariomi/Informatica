...
if ('\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
