...
if "%PHPBIN%" == "" set PHPBIN=\Users\mario.farag\Documents\Informatica2024\Informatica\Pavan_Diego\Data_b\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Users\mario.farag\Documents\Informatica2024\Informatica\Pavan_Diego\Data_b\xampp\php\phpunit" %*
