...
FOR %%x IN ("\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\Mario.farag\Documents\Informatica\Pavan_Diego\Data_b\xampp\php\php.exe"
GOTO :INSTALLED
